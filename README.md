...
- Once the custom templates container directories are ready, you have to add the custom templates `PHTML` files to them.  
(Template file name must not be a [node type](#available-node-types).)
