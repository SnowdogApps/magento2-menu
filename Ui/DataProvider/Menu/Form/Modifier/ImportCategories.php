...
namespace Snowdog\Menu\Ui\DataProvider\Menu\Form\Modifier;
                ...
                'arguments' => [
                    'data' => [
                        'config' => [
                            ...
                            'actions' => [
                                [
                                    'targetName' => 'snowmenu_menu_form.snowmenu_menu_form.create_category_modal',
                                    'actionName' => 'toggleModal',
                                ],
                                [
                                    'targetName' =>
                                        'snowmenu_menu_form.snowmenu_menu_form.create_category_modal.create_category',
                                    'actionName' => 'render'
                                ],
                                [
                                    'targetName' =>
