...
- Handle menu child nodes of pending parent nodes in nodes export tree generation process ([#206](https://github.com/SnowdogApps/magento2-menu/issues/206))
- Sort menu nodes according to their positions in nodes export tree generation process ([#206](https://github.com/SnowdogApps/magento2-menu/issues/206))
